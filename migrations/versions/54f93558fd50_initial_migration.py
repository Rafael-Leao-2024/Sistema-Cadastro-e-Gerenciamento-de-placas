...
Revision ID: 54f93558fd50
Revises: 
Create Date: 2024-12-21 23:29:31.544651
...
def upgrade():
    ...
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('id_pagamento', sa.String(length=255), nullable=False),
    sa.Column('status_pagamento', sa.String(length=50), nullable=False),
    sa.Column('id_usuario', sa.Integer(), nullable=False),
    sa.Column('date_pagamento', sa.DateTime(), nullable=False),
